"""
Django settings for bold_union_38911 project.
...
ROOT_URLCONF = 'bold_union_38911.urls'
...
WSGI_APPLICATION = 'bold_union_38911.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "bold_union_38911 API",
    "DESCRIPTION": "API documentation for bold_union_38911 App",
    "VERSION": "v1",
}
